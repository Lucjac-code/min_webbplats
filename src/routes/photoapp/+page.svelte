...
<p>
        "Denna sida innehåller <strong>fina</strong> bilder"
...
<div class= "photos">
        ...
        <div class= "image-wrapper"><img src= {photo} alt= "Flexbox egenskaper"></div>
        <div class= "image-wrapper"><img src= {picture} alt= "Flexbox egenskaper"></div>
